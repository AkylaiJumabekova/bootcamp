...
function render() {
    ...
    fetch(`https://jsonplaceholder.typicode.com/posts?_page=${page}&_limit=10`)
        ...
        .then(data => data.slice(0, 20).forEach(item => {
            container.innerHTML += `
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-dark user-btn" id="authorId-${item.userId}" data-bs-toggle="modal" data-bs-target="#exampleModal">About author</button>
                    </div>
                </div>
            `
        }))
